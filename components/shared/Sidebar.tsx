...
const navItems = [
  ...
  { href: '/configuracoes', label: 'Configuracoes', icon: Settings, gestorOnly: true },
]
...
export default function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'flex flex-col bg-surface border-r border-border transition-all duration-200 h-screen sticky top-0 shrink-0',
        collapsed ? 'w-16' : 'w-56'
      )}
    >
      {/* Logo */}
